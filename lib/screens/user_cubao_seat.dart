...
class UserCubaoSeatSelection extends StatefulWidget {
  final int numberOfSeats;
  // The number of seats the user can select

  const UserCubaoSeatSelection({
    super.key,
    required this.numberOfSeats,
  });

  @override
  _UserCubaoSeatSelectionScreenState createState() =>
      _UserCubaoSeatSelectionScreenState();
}

class _UserCubaoSeatSelectionScreenState extends State<UserCubaoSeatSelection> {
