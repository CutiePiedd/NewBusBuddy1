...
class DagupanSeatSelection extends StatefulWidget {
  final int numberOfSeats; // The number of seats the user can select

  const DagupanSeatSelection({super.key, required this.numberOfSeats});

  @override
  _DagupanSeatSelectionScreenState createState() =>
      _DagupanSeatSelectionScreenState();
}

class _DagupanSeatSelectionScreenState extends State<DagupanSeatSelection> {
