...
class ManilaTicketScreen extends StatelessWidget {
  const ManilaTicketScreen({super.key});
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        Text('Home',
                            style: TextStyle(
                                color: Colors
                                    .white)), // Optional: Add text beside the icon
                      ],
                    ),
                  ),
                ),
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: const Row(
                      ...
                      children: [
                        Icon(Icons.receipt,
                            color: Colors.white), // Receipt icon
                        SizedBox(width: 8), // Space between icon and text
                        Text('Receipt',
                            style: TextStyle(
                                color: Colors
