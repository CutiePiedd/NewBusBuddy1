...
class _UserTicketsScreenState extends State<UserTicketsScreen> {
  ...
  Future<void> _fetchTickets() async {
    try {
      ...
      List<dynamic> fetchedTickets = await apiService.fetchTickets();
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromARGB(
                          255, 246, 204, 35), // Back button style
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color.fromARGB(
                          255, 255, 144, 16), // Proceed button style
                      padding: const EdgeInsets.symmetric(
                          horizontal: 30.0, vertical: 20.0),
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(70.0)),
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      int ticketId =
                          1; // You need to replace with actual ticket ID
                      int userId = 1; // Replace with the actual user ID
                      List<int> selectedSeats = [1, 2]; // Example seat numbers

                      await reserveSeats(ticketId, selectedSeats, userId);
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor:
                          Color.fromARGB(255, 204, 29, 29), // Dark color
                      shape: const RoundedRectangleBorder(
                        borderRadius: BorderRadius.only(
